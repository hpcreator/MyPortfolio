...
enum class Experience(
    ...
    VALTECH(
        ...
        description = "Work with cross functional team, ensuring timely delivery and adherence to quality standards. Designed, developed, and maintained complex Android applications using Kotlin. Optimized app performance and user experience across Android Automotive versions. Collaborated with design teams, translating wireframes and mockups into functional app features. Implemented robust RESTful APIs and JSON data integration to enhance app functionality. Utilized Git for efficient code versioning and collaboration. Conducted thorough testing and debugging to resolve app issues. Contributed to the entire software development lifecycle, from requirements gathering to deployment.",
        companyName = "Valtech India Systems Private Ltd.",
